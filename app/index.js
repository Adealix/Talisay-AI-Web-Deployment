...
const HOME_PRODUCTS = [
  ...
  {
    id: 'biodiesel',
    imageUri: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400',
    icon: 'flame',
    color: '#ef4444',
  ...
  return (
    ...
    >
      ...
      {item.imageUri && !imgError ? (
        ...
        <View style={[styles.fpImage, { backgroundColor: item.color + '12', alignItems: 'center', justifyContent: 'center' }]}>
